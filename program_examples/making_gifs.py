...
for n in np.arange(1, 10, 0.02):
    ...
    img.save(rf"C:\Users\Chris\Documents\PycharmProjects\mandelpy\images\increasing_powers2\Pic"
             rf"{i}.png", optimize=True, quality=50)  # since gif is lossless, we can just use png


make_gif(r"C:\Users\Chris\Documents\PycharmProjects\mandelpy\images\increasing_powers2",
